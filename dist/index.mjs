...
var ActivityLogClient = makeGenericClientConstructor(
  ActivityLogService,
...
var AuthenticationClient = makeGenericClientConstructor2(
...
import {
  makeGenericClientConstructor as makeGenericClientConstructor3
} from "@grpc/grpc-js";
...
var BookmarkCollectionsEntriesManagerClient = makeGenericClientConstructor3(
...
import {
  makeGenericClientConstructor as makeGenericClientConstructor4
} from "@grpc/grpc-js";
...
var BookmarkCollectionManagerClient = makeGenericClientConstructor4(
...
var ErrorResponse = {
  encode(message, writer = new BinaryWriter5()) {
    if (message.code !== 0) {
...
import {
  makeGenericClientConstructor as makeGenericClientConstructor5
} from "@grpc/grpc-js";
...
var HealthCheckRequest = {
  encode(_, writer = new BinaryWriter6()) {
    return writer;
  },
  decode(input, length) {
...
var HealthCheckClient = makeGenericClientConstructor5(
  HealthCheckService,
...
import {
  makeGenericClientConstructor as makeGenericClientConstructor6
} from "@grpc/grpc-js";
...
var UserProfileClient = makeGenericClientConstructor6(
  UserProfileService,
...
export {
  activity_exports as activity,
  authentication_exports as authentication,
  bookmark_collection_entries_exports as bookmark_collection_entries,
  bookmark_collections_exports as bookmark_collections,
  common_exports as common,
  health_check_exports as health_check,
  user_profile_exports as user_profile
};
